...
//		let container = NSPersistentContainer(name: "NewsFeedEntity")
...
//	// Сохранение новости
//	func saveNews(with model: NewsModel) {
//		let news = NewsFeedEntity(context: context)
...
//
//	func deleteNews() {
//		let fetchRequest: NSFetchRequest<NSFetchRequestResult> = NewsFeedEntity.fetchRequest()
